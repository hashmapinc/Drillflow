...
public class DotTranslatorTest {
    ...
    @Test
    public void translateQueryResponseTest() throws ValveException {
        ...
        AbstractWitsmlObject abstractWitsmlObject = DotTranslator.translateQueryResponse(query, response, objectType);
