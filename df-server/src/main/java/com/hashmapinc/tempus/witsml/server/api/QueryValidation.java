...
public class QueryValidation {
	 ...
	 * @param CapabilitiesIn
	 * @param version
	 * @param storeFunction  - Add, Get, Update or Delete
	 * @return
	 * @throws IOException
	 */
	...
	public static String getErrorMessage(Short errorCode) throws IOException {
		...
		// TODO: Error code -1 is set in code now. Ideally should be fetched from
		// .properties file
		if (errorCode == -1) {
	 ...
	 */
	enum ERRORCODE {
		ERROR_401("-401"), ERROR_402("-402"), ERROR_403("-403"), ERROR_404("404"), ERROR_405("405"), ERROR_406("406"),
		ERROR_407("-407"), ERROR_408("-408"), ERROR_409("-409"), ERROR_410("-410"), ERROR_411("-411"),
		ERROR_412("-412"), ERROR_413("-413"), ERROR_414("-414"), ERROR_415("-415"), ERROR_416("-416"),
		ERROR_417("-417"), ERROR_418("-418"), ERROR_419("-419"), ERROR_420("-420"), ERROR_421("-421"),
		ERROR_422("-422"), ERROR_423("-423"), ERROR_424("-424"), ERROR_425("-425"), ERROR_426("-426"),
		ERROR_427("-427"), ERROR_428("-428"), ERROR_429("-429"), ERROR_430("-430"), ERROR_431("-431"),
		ERROR_432("-432"), ERROR_433("-433"), ERROR_434("-434"), ERROR_435("-435"), ERROR_436("-436"),
		ERROR_437("-437"), ERROR_438("-438"), ERROR_439("-439"), ERROR_440("-440"), ERROR_441("-441"),
		ERROR_442("-442"), ERROR_443("-443"), ERROR_444("-444"), ERROR_445("-445"), ERROR_446("-446"),
		ERROR_447("-447"), ERROR_448("-448"), ERROR_449("-449"), ERROR_450("-450"), ERROR_451("-451"),
		ERROR_452("-452"), ERROR_453("-453"), ERROR_454("-454"), ERROR_455("-455"), ERROR_456("-456"),
		ERROR_457("-457"), ERROR_458("-458"), ERROR_459("-459"), ERROR_460("-460"), ERROR_461("-461"),
		ERROR_462("-462"), ERROR_463("-463"), ERROR_464("-464"), ERROR_465("-465"), ERROR_466("-466"),
		ERROR_467("-467"), ERROR_468("-468"), ERROR_469("-469"), ERROR_470("-470"), ERROR_471("-471"),
